...
class RobertaSelfAttention(nn.Module):
    ...
    def __init__(self, config, is_cross_attention):
        ...
        self.attn_gradients, self.attention_map = None, None
...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def get_extended_attention_mask(self, attention_mask: torch.Tensor, input_shape: Tuple[int],
                                    device: torch.device, is_decoder: bool) -> torch.Tensor:
        """
        Makes broadcastable attention and causal masks so that future and masked tokens are ignored.

        Arguments:
            is_decoder: not so important
...
class RobertaForCausalLM(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        lm_loss, shifted_prediction_scores = None, None
        if labels is not None:
        ...
        if soft_labels is not None:
            assert shifted_prediction_scores is not None
