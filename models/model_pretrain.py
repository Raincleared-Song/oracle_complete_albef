...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        self.text_encoder_m = RobertaForMaskedLM.from_pretrained(text_encoder, config=roberta_config)
        ...
        self.mlm_max_retry = mlm_max_retry
    ...
    def forward(self, images, input_ids, attn_masks, mode, alpha=0):
        ...
        with torch.no_grad():
            ...
            text_output_m = self.text_encoder_m.roberta(input_ids, attention_mask=attn_masks,
                                                        return_dict=True, mode='text')
        ...
        with torch.no_grad():
            logits_m = self.text_encoder_m(mlm_input_ids,
                                           attention_mask=attn_masks,
