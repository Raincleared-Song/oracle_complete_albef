...
python Image_Reconstruct.py --config ./output/tra_image_reconstruct_vit_all_mk50_ranoise_lr4/config.yaml --mode test --checkpoint output/tra_image_reconstruct_vit_all_mk50_ranoise_lr4/checkpoint_58.pth
